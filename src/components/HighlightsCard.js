...
import Dessert1 from "../assets/icons_assets/greeksalad.jpg";
import Dessert2 from "../assets/icons_assets/bruchetta.svg";
import Dessert3 from "../assets/icons_assets/lemondessert.jpg";
...
const HighlightsCard = () => {
  const specialMenus = [
    ...
    },
    {
      ...
      price: "$5.00",
      description:
        "This comes straight from Grandma's recipe book. Every last ingredient has been sourced and is as authentic as can be imagined. You will not be disappointed.",
      order: "Order a delivery"
    }
  ];
